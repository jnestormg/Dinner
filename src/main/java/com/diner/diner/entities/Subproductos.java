...
public class Subproductos {
    ...
    public Subproductos(SubproductoDTO subproductoDTO){
        this.nombre = subproductoDTO.nombre();
        this.descripcion = subproductoDTO.descripcion();
        this.precio = subproductoDTO.precio();
    }
}
